...
START   SEI             ; PREVENT INTERRUPTS WHILE WE SET THINGS UP
        ...
        STA  $D01C      ; SPRITE 0 IS MULTICOLOR
        STA  $D027      ; SPRITE 0 COLOR IS WHITE
        LDA  #$0B       ; SPRITE 0 COLOR 1 IS DARK GREY
        STA  $D025      ;
        LDA  #$07       ; SPRITE 0 COLOR 2 IS YELLOW
        STA  $D026
        ...
        STA  $D001      ; SHORTER RASTER LINES). ALSO THE BAR CANNOT
                        ...
                        ; WILL CHANGE AS SOON AS OUT OF THE SPRITE AREA
